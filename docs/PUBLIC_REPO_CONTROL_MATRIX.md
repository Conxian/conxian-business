...
> **Observation date:** 2026-07-25 (live GitHub metadata observed at 2026-07-25T10:30:09Z)
>
...
The organization profile exposed only [`Conxian/Conxian`](https://github.com/Conxian/Conxian) as pinned on 2026-07-25. This is an observation, not a request to change organization settings.
...
This set balances protocol, enterprise infrastructure, user access, public narrative, and browser discovery. It is a recommendation only; no organization-setting change is part of this control matrix.
...
Evidence was collected from each canonical GitHub repository page and its public `releases`, `tags`, root README, `CODEOWNERS`, governance file, and root manifest where applicable. Organization pin state was read from the GitHub organization pinned-items metadata. The observation is time-bound to 2026-07-25; later repository or organization changes supersede this snapshot.
