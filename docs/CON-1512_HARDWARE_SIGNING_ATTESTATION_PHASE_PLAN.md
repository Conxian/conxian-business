...
| SDK PR [#244](https://github.com/Conxian/conxius-enclave-sdk/pull/244) at head `b6cac48ac5a874a29198ebf1b0b3f36c3ac4303f` | Open implementation PR with reported checks passing; requires the canonical six-proof rail before settlement authorization. | **Selected containment candidate.** It is not merged, does not provide a production verifier registry, and enables no hardware provider. |
...
| SDK issue [#241](https://github.com/Conxian/conxius-enclave-sdk/issues/241) | Open Android KeyMint/StrongBox and Play Integrity qualification track. | Candidate device/app authorization and platform-evidence path; no current production qualification. |
...
| Android track [#241](https://github.com/Conxian/conxius-enclave-sdk/issues/241) | supplies | phone/client platform evidence | KeyMint/StrongBox and server-verified Play Integrity can authorize a device/app/key; they do not by themselves prove protocol-key custody. |
...
- **Phone/client:** Android KeyMint/StrongBox plus server-verified Play Integrity for device/app/key authorization. Keep the authorization key and any protocol signer distinct; Android P-256 evidence is not secp256k1/Schnorr custody evidence.
