...
>
> **GitHub authority:** https://github.com/Conxian/conxian-business/issues?q=CON-1512
...
The GitHub implementation decomposition is:

- Parent: https://github.com/Conxian/conxian-business/issues?q=CON-1512
- Shared trust and replay prerequisite: https://github.com/Conxian/conxian-business/issues?q=CON-1543
- Android track: https://github.com/Conxian/conxian-business/issues?q=CON-1544
- AWS Nitro track: https://github.com/Conxian/conxian-business/issues?q=CON-1545
- Runtime/platform evidence: https://github.com/Conxian/conxian-business/issues?q=CON-1517
- Independent review and release acceptance: https://github.com/Conxian/conxian-business/issues?q=CON-1519
- Downstream wallet enforcement: https://github.com/Conxian/conxian-business/issues?q=CON-1546

The live GitHub and GitHub states referenced below were revalidated on **July 22, 2026**: CON-1512 is **Urgent / In Progress**, CON-1543 is **Urgent / Triage**, CON-1544 is **Urgent / In Review**, CON-1519 is **Urgent / Triage**, and CON-1546 is **Urgent / Triage**. Repository, issue, and pull-request state is administrative evidence only; it does not promote a capability into production support.
...
### Six evidence lanes that remain separate

The three-claim taxonomy is necessary but not sufficient for auditability. The implementation and acceptance work is split into six evidence lanes; progress in one lane cannot be promoted into another.

| Evidence lane | Current scope and artifact boundary | Required evidence before promotion | Explicit no-go |
| --- | --- | --- | --- |
| **Android client evidence/token collection and deterministic request binding** | Merged wallet boundaries [#441](https://github.com/Conxian/conxius-wallet/pull/441) and [#442](https://github.com/Conxian/conxius-wallet/pull/442), merged SDK boundary [#243](https://github.com/Conxian/conxius-enclave-sdk/pull/243), merged SDK hardening [#246](https://github.com/Conxian/conxius-enclave-sdk/pull/246) (**2026-07-22 16:36:34 UTC**), and open wallet hardening follow-up [#443](https://github.com/Conxian/conxius-wallet/pull/443) define bounded client/SDK collection and binding interfaces. | Canonical serialization and digest binding for the exact operation, nonce/challenge, audience, package/signing identity, key identity, purpose, algorithm, and evidence/token digests, with deterministic positive and negative vectors. | A client-collected token, a request-bound envelope, or a merged interface PR does not qualify a real device/provider or create an authoritative backend verdict. |
| **Trusted backend certificate/token verification and revocation** | [SDK #240](https://github.com/Conxian/conxius-enclave-sdk/issues/240), [CON-1543](https://github.com/Conxian/conxian-business/issues?q=CON-1543), and the still-open [CON-1544](https://github.com/Conxian/conxian-business/issues?q=CON-1544) own the operational trust boundary. | A versioned verifier registry must validate the certificate chain, trusted roots, current collateral, revocation, Play Integrity token claims, release package/signing identity, exact request binding, and normalized policy outcome. | Presence of a certificate/token, client-side parsing, or structural evidence does not prove server verification, current revocation status, or provider qualification. |
| **Freshness and durable replay** | Freshness and replay remain shared prerequisites under [SDK #240](https://github.com/Conxian/conxius-enclave-sdk/issues/240) and [CON-1543](https://github.com/Conxian/conxian-business/issues?q=CON-1543); the current research record does not claim a completed distributed service. | Trusted time/expiry, nonce or challenge uniqueness, stale-result rejection, and an atomic durable `consume_once` decision that survives restart, replica changes, and recovery. | A process-local cache, client timestamp, test fixture, or one successful request does not establish durable replay protection. |
| **Production authorization enforcement** | Merged interface/containment PRs remain bounded inputs to the enforcement work. The wallet gate and provider-neutral envelope are tracked by [wallet #444 / CON-1546](https://github.com/Conxian/conxius-wallet/issues/444), while the canonical SDK rail remains an open containment candidate in [#244](https://github.com/Conxian/conxius-enclave-sdk/pull/244). | One fail-closed production gate must combine authoritative evidence, exact operation binding, freshness/replay, signer policy, and typed outcomes; software, mock, debug, and synthetic-success routes must be ineligible for value operations. | A merged interface PR, passing CI, a current branch, or a UI confirmation does not authorize production value operations. |
| **Protocol-key custody** | Protocol-key custody is a separate acceptance lane under [CON-1512](https://github.com/Conxian/conxian-business/issues?q=CON-1512) and the hardware-backed signing umbrella [SDK #195](https://github.com/Conxian/conxius-enclave-sdk/issues/195). Android P-256 authorization remains distinct from Bitcoin/Stacks secp256k1/Schnorr signing. | Exact protocol-key identity, non-exportability or approved custody boundary, signer authorization, algorithm/payload binding, deterministic protocol vectors, and exact runtime/release evidence. | KeyMint/StrongBox or Play Integrity evidence does not establish custody of the Bitcoin/Stacks protocol key or prove the required protocol signature path. |
| **Independent release acceptance** | [CON-1519](https://github.com/Conxian/conxian-business/issues?q=CON-1519) and [SDK #202](https://github.com/Conxian/conxius-enclave-sdk/issues/202) remain the independent review and release gate. | Exact source/artifact identity, SBOM, provenance, dependency/security evidence, version and pin synchronization, capability-by-capability test evidence, and independent review of the claimed scope. | A merged pull request, current head, green CI, or generated documentation does not establish independent release acceptance. |

### No-go claims retained across all lanes

- Merged interface PRs [SDK #243](https://github.com/Conxian/conxius-enclave-sdk/pull/243), wallet [#441](https://github.com/Conxian/conxius-wallet/pull/441), and wallet [#442](https://github.com/Conxian/conxius-wallet/pull/442) do not qualify real devices or providers.
- Those PRs do not prove trusted backend certificate/token verification, revocation, or durable distributed replay.
- They do not enforce production authorization, establish Bitcoin/Stacks protocol-key custody, or satisfy independent release acceptance.
- Merged SDK hardening [#246](https://github.com/Conxian/conxius-enclave-sdk/pull/246) (**2026-07-22 16:36:34 UTC**) remains a bounded implementation artifact; open wallet hardening [#443](https://github.com/Conxian/conxius-wallet/pull/443), plus open [SDK #240](https://github.com/Conxian/conxius-enclave-sdk/issues/240), [CON-1544](https://github.com/Conxian/conxian-business/issues?q=CON-1544), and [CON-1519](https://github.com/Conxian/conxian-business/issues?q=CON-1519), remain explicit gates rather than completion claims.
...
| SDK issue [#241](https://github.com/Conxian/conxius-enclave-sdk/issues/241) / GitHub [CON-1544](https://github.com/Conxian/conxian-business/issues?q=CON-1544) | GitHub issue **open**; GitHub issue **Urgent / In Review** as of July 22, 2026. | Qualification remains incomplete: trusted roots/collateral, server-side verification, real-device/runtime evidence, exact key/operation binding, replay, and independent release acceptance remain required; unsupported production paths stay fail closed. |
| SDK PR [#243](https://github.com/Conxian/conxius-enclave-sdk/pull/243) at live head [`ed5b68c10a7a87a37638f1415e876e017484d596`](https://github.com/Conxian/conxius-enclave-sdk/commit/ed5b68c10a7a87a37638f1415e876e017484d596) | **Merged** Android authorization-evidence boundary. | Bounded SDK evidence/request interface only; does not qualify a provider, real device, backend verifier, protocol-key custody, or release. |
| SDK PR [#246](https://github.com/Conxian/conxius-enclave-sdk/pull/246) at live head [`ff890328b2e7fa0490c2ea7675058c3201c56ece`](https://github.com/Conxian/conxius-enclave-sdk/commit/ff890328b2e7fa0490c2ea7675058c3201c56ece) | **Merged** on **2026-07-22 16:36:34 UTC** — Android authorization-binding hardening. | Merged review/implementation evidence remains bounded; no provider/device qualification, production support, durable replay, protocol-key custody, authorization enforcement, or independent release acceptance claim. |
...
| Wallet PR [#441](https://github.com/Conxian/conxius-wallet/pull/441) at live head [`216b70fb4d42e61a61f4ef623a281c860a94fc02`](https://github.com/Conxian/conxius-wallet/commit/216b70fb4d42e61a61f4ef623a281c860a94fc02) | **Merged** KeyMint authorization boundary. | Bounded wallet-side authorization interface only; does not qualify real devices/providers, backend verification, protocol-key custody, or production value authorization. |
| Wallet PR [#442](https://github.com/Conxian/conxius-wallet/pull/442) at live head [`722aaa15e56fd089820a2f277e13595c359b24ff`](https://github.com/Conxian/conxius-wallet/commit/722aaa15e56fd089820a2f277e13595c359b24ff) | **Merged** Play Integrity SDK request boundary. | Bounded client token/request collection and binding only; server-side verification, revocation, real-device qualification, and production authorization remain open. |
| Wallet PR [#443](https://github.com/Conxian/conxius-wallet/pull/443) at live head [`ee96fdfd9a5bcf09e598dd029a357138b3097fda`](https://github.com/Conxian/conxius-wallet/commit/ee96fdfd9a5bcf09e598dd029a357138b3097fda) | **Open** KeyMint authorization-evidence hardening follow-up. | Review/implementation evidence remains bounded and unmerged; no production qualification claim. |
...
Stable bounded interface/containment artifacts linked to this snapshot are merged SDK Android boundary [#243](https://github.com/Conxian/conxius-enclave-sdk/pull/243), merged SDK hardening [#246](https://github.com/Conxian/conxius-enclave-sdk/pull/246) (**2026-07-22 16:36:34 UTC**), open provider-neutral contracts [#245](https://github.com/Conxian/conxius-enclave-sdk/pull/245) with current review findings [#4755943314](https://github.com/Conxian/conxius-enclave-sdk/pull/245#pullrequestreview-4755943314), merged wallet KeyMint boundary [#441](https://github.com/Conxian/conxius-wallet/pull/441), merged wallet Play Integrity request boundary [#442](https://github.com/Conxian/conxius-wallet/pull/442), and open wallet hardening follow-up [#443](https://github.com/Conxian/conxius-wallet/pull/443). These are bounded interface/containment artifacts only: they do not establish production provider verification, durable replay, real-device qualification, protocol-key custody evidence, or independent release acceptance. PR #245's current review identified unresolved policy-digest/expected-collateral binding, idempotent-vs-conflicting replay outcome, deserialization invariant, and non-production replay-store registration gaps; SDK #240 and CON-1543 remain open shared prerequisites, and this update does not modify PR #245.
...
| Android evidence | Merged client/SDK boundaries now cover bounded KeyMint evidence and Play Integrity request/token collection, with open hardening follow-ups; they are not the backend verifier. | Android qualification still requires real-device evidence, attested signing-key authorization, certificate-chain and token validation, revocation, freshness, exact request binding, and independent acceptance. |
...
| SDK [#243](https://github.com/Conxian/conxius-enclave-sdk/pull/243) and wallet [#441](https://github.com/Conxian/conxius-wallet/pull/441) / [#442](https://github.com/Conxian/conxius-wallet/pull/442) | provide | client evidence/request-boundary artifacts | These PRs are merged interface/containment evidence only; SDK [#246](https://github.com/Conxian/conxius-enclave-sdk/pull/246) is now also merged hardening, while wallet [#443](https://github.com/Conxian/conxius-wallet/pull/443) remains open. |
| SDK [#246](https://github.com/Conxian/conxius-enclave-sdk/pull/246) and wallet [#443](https://github.com/Conxian/conxius-wallet/pull/443) | harden | deterministic Android authorization binding | SDK #246 merged at **2026-07-22 16:36:34 UTC**; wallet #443 remains open. Neither qualifies providers, backend verification, protocol-key custody, or production value operations. |
...
| Runtime/release evidence synchronization — [CON-1517](https://github.com/Conxian/conxian-business/issues?q=CON-1517) and [CON-1519](https://github.com/Conxian/conxian-business/issues?q=CON-1519) | 4 | 3 | 2 | 4 | 5 | **69** | Follow-on release and acceptance synchronization; not optional for promotion. |
...
8. **Merged interfaces are not qualification.** A merged client/SDK boundary, green CI, or deterministic request-binding test does not prove real-device/provider qualification, trusted backend verification, durable replay, protocol-key custody, production authorization, or independent release acceptance.
