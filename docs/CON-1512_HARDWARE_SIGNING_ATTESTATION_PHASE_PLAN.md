...
| --- | --- | --- | --- |
| **Android client evidence/token collection and deterministic request binding** | Merged wallet boundaries [#441](https://github.com/Conxian/conxius-wallet/pull/441) and [#442](https://github.com/Conxian/conxius-wallet/pull/442), merged SDK boundary [#243](https://github.com/Conxian/conxius-enclave-sdk/pull/243), and open hardening follow-ups [wallet #443](https://github.com/Conxian/conxius-wallet/pull/443) and [SDK #246](https://github.com/Conxian/conxius-enclave-sdk/pull/246) define bounded client/SDK collection and binding interfaces. | Canonical serialization and digest binding for the exact operation, nonce/challenge, audience, package/signing identity, key identity, purpose, algorithm, and evidence/token digests, with deterministic positive and negative vectors. | A client-collected token, a request-bound envelope, or a merged interface PR does not qualify a real device/provider or create an authoritative backend verdict. |
...
- Open hardening follow-ups [SDK #246](https://github.com/Conxian/conxius-enclave-sdk/pull/246) and wallet [#443](https://github.com/Conxian/conxius-wallet/pull/443), plus open [SDK #240](https://github.com/Conxian/conxius-enclave-sdk/issues/240), [CON-1544](https://linear.app/conxian-labs/issue/CON-1544/p0-qualify-android-keymintstrongbox-authorization-and-play-integrity), and [CON-1519](https://linear.app/conxian-labs/issue/CON-1519/p0-complete-independent-security-review-and-release-acceptance), remain explicit gates rather than completion claims.
...
| SDK PR [#246](https://github.com/Conxian/conxius-enclave-sdk/pull/246) at live head [`ff890328b2e7fa0490c2ea7675058c3201c56ece`](https://github.com/Conxian/conxius-enclave-sdk/commit/ff890328b2e7fa0490c2ea7675058c3201c56ece) | **Open** Android authorization-binding hardening follow-up. | Review/implementation evidence remains bounded and unmerged; no production qualification claim. |
...
Stable bounded interface/containment artifacts linked to this snapshot are merged SDK Android boundary [#243](https://github.com/Conxian/conxius-enclave-sdk/pull/243), open SDK hardening follow-up [#246](https://github.com/Conxian/conxius-enclave-sdk/pull/246), open provider-neutral contracts [#245](https://github.com/Conxian/conxius-enclave-sdk/pull/245) with current review findings [#4755943314](https://github.com/Conxian/conxius-enclave-sdk/pull/245#pullrequestreview-4755943314), merged wallet KeyMint boundary [#441](https://github.com/Conxian/conxius-wallet/pull/441), merged wallet Play Integrity request boundary [#442](https://github.com/Conxian/conxius-wallet/pull/442), and open wallet hardening follow-up [#443](https://github.com/Conxian/conxius-wallet/pull/443). These are bounded interface/containment artifacts only: they do not establish production provider verification, durable replay, real-device qualification, protocol-key custody evidence, or independent release acceptance. PR #245's current review identified unresolved policy-digest/expected-collateral binding, idempotent-vs-conflicting replay outcome, deserialization invariant, and non-production replay-store registration gaps; SDK #240 and CON-1543 remain open shared prerequisites, and this update does not modify PR #245.
...
| SDK [#243](https://github.com/Conxian/conxius-enclave-sdk/pull/243) and wallet [#441](https://github.com/Conxian/conxius-wallet/pull/441) / [#442](https://github.com/Conxian/conxius-wallet/pull/442) | provide | client evidence/request-boundary artifacts | These PRs are merged interface/containment evidence only; open hardening remains in SDK [#246](https://github.com/Conxian/conxius-enclave-sdk/pull/246) and wallet [#443](https://github.com/Conxian/conxius-wallet/pull/443). |
| SDK [#246](https://github.com/Conxian/conxius-enclave-sdk/pull/246) and wallet [#443](https://github.com/Conxian/conxius-wallet/pull/443) | harden | deterministic Android authorization binding | Both follow-ups remain open and do not qualify providers, backend verification, protocol-key custody, or production value operations. |
