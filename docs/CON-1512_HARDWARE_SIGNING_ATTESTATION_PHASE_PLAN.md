...
- Downstream wallet enforcement: https://linear.app/conxian-labs/issue/CON-1546/p0-add-centralized-wallet-value-operation-gate-and-quarantine

The live GitHub and Linear states referenced below were revalidated on **July 22, 2026**: CON-1512 is **Urgent / In Progress**, CON-1543 is **Urgent / Triage**, CON-1544 is **Urgent / In Review**, CON-1519 is **Urgent / Triage**, and CON-1546 is **Urgent / Triage**. Repository, issue, and pull-request state is administrative evidence only; it does not promote a capability into production support.
...
| **Trusted backend certificate/token verification and revocation** | [SDK #240](https://github.com/Conxian/conxius-enclave-sdk/issues/240), [CON-1543](https://linear.app/conxian-labs/issue/CON-1543/p0-operationalize-attestation-roots-collateral-revocation-and), and the still-open [CON-1544](https://linear.app/conxian-labs/issue/CON-1544/p0-qualify-android-keymintstrongbox-authorization-and-play-integrity) own the operational trust boundary. | A versioned verifier registry must validate the certificate chain, trusted roots, current collateral, revocation, Play Integrity token claims, release package/signing identity, exact request binding, and normalized policy outcome. | Presence of a certificate/token, client-side parsing, or structural evidence does not prove server verification, current revocation status, or provider qualification. |
| **Freshness and durable replay** | Freshness and replay remain shared prerequisites under [SDK #240](https://github.com/Conxian/conxius-enclave-sdk/issues/240) and [CON-1543](https://linear.app/conxian-labs/issue/CON-1543/p0-operationalize-attestation-roots-collateral-revocation-and); the current research record does not claim a completed distributed service. | Trusted time/expiry, nonce or challenge uniqueness, stale-result rejection, and an atomic durable `consume_once` decision that survives restart, replica changes, and recovery. | A process-local cache, client timestamp, test fixture, or one successful request does not establish durable replay protection. |
...
| **Protocol-key custody** | Protocol-key custody is a separate acceptance lane under [CON-1512](https://linear.app/conxian-labs/issue/CON-1512/p0-enforce-hardware-backed-signing-and-mandatory-attestation-for-value) and the hardware-backed signing umbrella [SDK #195](https://github.com/Conxian/conxius-enclave-sdk/issues/195). Android P-256 authorization remains distinct from Bitcoin/Stacks secp256k1/Schnorr signing. | Exact protocol-key identity, non-exportability or approved custody boundary, signer authorization, algorithm/payload binding, deterministic protocol vectors, and exact runtime/release evidence. | KeyMint/StrongBox or Play Integrity evidence does not establish custody of the Bitcoin/Stacks protocol key or prove the required protocol signature path. |
...
- Merged SDK hardening [#246](https://github.com/Conxian/conxius-enclave-sdk/pull/246) (**2026-07-22 16:36:34 UTC**) remains a bounded implementation artifact; open wallet hardening [#443](https://github.com/Conxian/conxius-wallet/pull/443), plus open [SDK #240](https://github.com/Conxian/conxius-enclave-sdk/issues/240), [CON-1544](https://linear.app/conxian-labs/issue/CON-1544/p0-qualify-android-keymintstrongbox-authorization-and-play-integrity), and [CON-1519](https://linear.app/conxian-labs/issue/CON-1519/p0-complete-independent-security-review-and-release-acceptance), remain explicit gates rather than completion claims.
