...
- **Public-safe stub (canonical in Linear)**: safe to link publicly; this repo file is a short pointer stub (see [ZSE stub template](./templates/ZSE_STUB_TEMPLATE.md)) and must not contain operational, security, financial, legal, or strategic details beyond the pointer; the full canonical content is maintained in Linear under ZSE.
