...
| `Conxian/lib-conxian-core` | Shared core | Missing (PR open) | Mainnet support | `default=main; dev=n; staged=n` | P0 | Missing `dev` and `staged`. Ownership: [#42](https://github.com/Conxian/lib-conxian-core/pull/42). |
