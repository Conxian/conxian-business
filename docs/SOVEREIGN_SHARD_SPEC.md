...
4. **TEE Attestation**: All transactions must be signed by a hardware enclave (StrongBox/TEE) verified by the conxius-enclave-sdk.

## 3. Technical Requirements
- **SDK**: `conxius-enclave-sdk` (pinned via the `conxian-business` submodule)
- **Protocol**: x402 / AP2
