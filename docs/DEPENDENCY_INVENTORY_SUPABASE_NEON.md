...
**Redaction convention:** internal endpoints/hostnames are replaced with `<redacted>` placeholders (for MCP endpoints: `mcp://<redacted>`), including in any referenced evidence artifacts pinned in this repo.
