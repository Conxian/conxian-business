...
Because this repo follows **Zero Secret Egress (ZSE)**, production connection strings, project refs, and keys are intentionally not present here. Wherever possible, each item is labeled with an **evidence level**.
