...
| `GAP-DOC-01` | Documentation | Cross-repo positioning and SLA commitments fragmented | Unified source-of-truth docs (`PORTFOLIO.md`, `SLA.md`, `ALIGNMENT.md`, `GAPS.md`) | Governance | Critical | Operational Unification | `docs/BOS_KNOWLEDGE_FRAMEWORK.md` | Verified |
...
| `GAP-SLA-01` | SLA & Pricing | Open-source vs enterprise SLA boundaries ambiguous; commercial pricing unmapped | Tiered Support Matrix (Public Core = No SLA vs Enterprise B2B SLA), BaaP 3-layer pricing, zero liability | Commercial / Risk | Critical | Operational Unification | `docs/SLA.md` | Verified |
...
| `CAN-05` Org-Wide SLA & BaaP Pricing | `GAP-SLA-01` | 5.0 | 5.0 | 5.0 | 5.0 | 5.0 | 5.0 | **5.00 / 5.0** | **Selected** |
