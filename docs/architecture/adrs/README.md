...
This directory contains the current architecture decision records for the BOS control-plane evolution work.

## ADR index
- [ADR-001: `conxian-business` is the BOS control plane](./ADR-001-bos-control-plane.md)
- [ADR-002: TypeScript for application surfaces, Rust for trusted runtime](./ADR-002-language-strategy.md)
