...
| `conxian_market/` | `supporting` | AI Marketplace and Agentic Commerce surface mapped in business repo. |
...
| `conxian_market/` | Submodule | **Agentic Commerce** (Market) | AI Marketplace + Agentic Commerce | Pinned submodule mapped in business repo for AI Marketplace and Agentic Commerce; update=none for CI. |
...
| `conxian_market/` | AI Marketplace & Agentic Commerce | Agentic commerce, AI market contracts, research | Discretionary asset management or proprietary market operation |
