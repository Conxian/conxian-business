...
Supporting — governance + orchestration hub for the Conxian ecosystem (OpenSpec, docs, and submodule wiring). See the [repo portfolio](docs/REPO_PORTFOLIO.md#ecosystem-repos) for the flagship/supporting repo map.
