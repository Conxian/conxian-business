...
- **GitHub Issues and pull requests are authoritative for new BOS governance work** under [`docs/GITHUB_NATIVE_BOS_WORKSPACE.md`](docs/GITHUB_NATIVE_BOS_WORKSPACE.md). Restricted systems, including historical Linear records, provide sanitized pointers or provenance rather than competing public-work authority.
...
| GitHub-native BOS workspace | governs | New public-safe BOS intake, coordination, decisions, and sanitized evidence indexing. |
