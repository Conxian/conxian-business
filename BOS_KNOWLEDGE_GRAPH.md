...
| Defer source-specific profile work | Generic intake precedes LEI-oriented or other domain-profile evaluation so no candidate is treated as accepted before evidence controls exist. |
