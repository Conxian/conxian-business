...
- Ensure every merge has clear GitHub issue/PR provenance.
...
- PRs should map to an authoritative GitHub issue or governing pull request (include it in the PR description).
