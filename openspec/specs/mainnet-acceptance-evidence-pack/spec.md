...
- Canonical remote fetch URL(s) (sanitize recorded value; redact any embedded credentials)
- Canonical remote push URL(s) (sanitize recorded value; redact any embedded credentials)
...
- Canonical remote fetch URL(s) (sanitize recorded value; redact any embedded credentials): `git remote get-url --all <canonical-remote>`
- Canonical remote push URL(s) (sanitize recorded value; redact any embedded credentials): `git remote get-url --push --all <canonical-remote>`
...
- Canonical remote fetch URL(s) (sanitize recorded value; redact any embedded credentials; `git remote get-url --all <canonical-remote>`): `<url(s)>`
- Canonical remote push URL(s) (sanitize recorded value; redact any embedded credentials; `git remote get-url --push --all <canonical-remote>`): `<url(s)>`
