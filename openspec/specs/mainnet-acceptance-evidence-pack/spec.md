...
> **Requirement (Readiness work visibility):** If any linked mainnet readiness work (e.g., readiness tracker) is not directly accessible to PR reviewers, the evidence pack MUST record the mainnet pass status directly.
...
- Linked mainnet readiness work (e.g., readiness tracker) is updated and shows mainnet pass status.
