...
- `settlement_identifiers.transaction_identifiers` is a JSON object whose values are strings; any non-string value causes canonicalization to fail for the corresponding settlement transaction.
