...
#### 2.1.1 `settlement_identifiers` (canonical set)<a id="settlement-identifiers-canonical"></a><a id="211-settlement_identifiers-per-rail-canonical-set"></a>
